export const projectData = [
  {
    ...
    live: "https://olx-clone-mern-mila9n.vercel.app/",
  },
  {
    title: "Contact Us",
    tags: [
...

  {
    ...
    description:
      "This project is a challenge from the Frontend.io website, which fetches country details from the rest-countries API and displays them as shown on the website. Clicking on a country takes the user to a new route with more details about that country. The Router allows for a seamless, multipage experience.",
